...
public class Autotransition implements Serializable {
	...
	@GeneratedValue(strategy=GenerationType.AUTO, generator="AUTOTRANSITION_AUTOTRANID_GENERATOR")
	...
	//bi-directional many-to-one association to fevInstitution
	@ManyToOne 
	private FevEventstatus feveventstatus;
	...
	public FevEventstatus getFevEventStatus() {
		return feveventstatus;
	}
	
	public void setFevEventStatus(FevEventstatus feveventstatus) {
		this.feveventstatus = feveventstatus;
	}
}